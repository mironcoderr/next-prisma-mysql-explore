...
import { getAllRestaurant } from "@/library/Restaurant";
import { deleteRestaurant } from "@/library/Restaurant";
...
export default async function Home() {
    ...
    return (
        <>
            <HeaderComponent title="all restaurant" label="create restaurant" path="/create-restaurant" />
                        ...
                        return (
                            <div key={index} className="rounded-xl overflow-hidden bg-white">
                                ...
                                <nav className="flex items-center justify-between border-t border-gray-100">
                                    ...
                                    <Link href={`/${restaurant.id}/update`} className="flex items-center justify-center w-full gap-1.5 py-2.5 border-r last:border-none border-gray-100 hover:bg-gray-50 transition-all duration-300 text-teal-500">
